...
func ConnectDatabase() (*gocqlx.Session, error) {
	...
	err = session.ExecStmt(`CREATE TABLE IF NOT EXISTS AppneuronTestDatabase.persons (
		...
		daily_average_session_count decimal,
		daily_average_Session_duration decimal,
		session_based_average_session_duration decimal,
		daily_average_session_count_minus_first_day_session_count decimal,
		daily_average_session_duration_minus_first_day_session_duration decimal,
		session_based_average_session_duration_minus_first_session_duration decimal,
		session_based_average_session_duration_minus_last_session_duration decimal,
